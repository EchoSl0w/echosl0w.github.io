...
Enhances the board pages' UI/UX
- [Tampermonkey Script](https://github.com/SoumyaK4/OGS-Tampermonkey)
...
- The [Baduk Clock](https://gotimer.soumyak4.in/) is an installable web app for any device
- Works offline too
- Supports all major Go time control systems
